...
define view entity ZKS_BOOKING
  as select from /dmo/booking_m
  composition [0..*] of ZKS_BOOKING_SUPPL            as _suppl
  association        to parent ZKS_R_TRAVEL                 as _travel on  $projection.TravelId = _travel.TravelId
  ...
  association of one to one /DMO/I_Booking_Status_VH as _bookingstat   on  $projection.BookingStatus = _bookingstat.BookingStatus
