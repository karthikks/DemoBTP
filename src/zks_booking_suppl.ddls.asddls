...
define view entity ZKS_BOOKING_SUPPL
  as select from /dmo/booksuppl_m
  association        to parent ZKS_BOOKING    as _booking        on  $projection.TravelId  = _booking.TravelId
                                                                 and $projection.BookingId = _booking.BookingId
  association [1..1] to ZKS_R_TRAVEL          as _travel         on  $projection.TravelId = _travel.TravelId
